...
let packages =
      H.modPackageList
        ...
        ( toMap
            ...
            , plutus-core = callCHaP "plutus-core" "1.11.0.0"
            , plutus-ledger-api = callCHaP "plutus-ledger-api" "1.11.0.0"
            , plutus-tx = callCHaP "plutus-tx" "1.11.0.0"
            , plutus-tx-plugin = callCHaP "plutus-tx-plugin" "1.11.0.0"
            , prettyprinter-configurable =
                callCHaP "prettyprinter-configurable" "1.11.0.0"
