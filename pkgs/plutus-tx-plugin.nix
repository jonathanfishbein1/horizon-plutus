...
mkDerivation {
  ...
  version = "1.8.0.0";
  src = fetchzip {
    url = "https://input-output-hk.github.io/cardano-haskell-packages/package/plutus-tx-plugin-1.8.0.0.tar.gz";
    sha256 = "1q6601npjpn79vai7hz8624l0xi46ljhq2xc77y5x2b4njvsy3mq";
  };
  isLibrary = true;
  isExecutable = true;
